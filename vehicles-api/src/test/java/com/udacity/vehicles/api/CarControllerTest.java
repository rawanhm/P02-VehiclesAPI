...
public class CarControllerTest {
    ...
    private Car getCar() {
        Car car = new Car();
        car.setLocation(new Location(70.730610, -73.937652));
        Details details = new Details();
        Manufacturer manufacturer = new Manufacturer(101, "Chevrolet");
        details.setManufacturer(manufacturer);
        details.setModel("Impala");
        details.setMileage(5463);
    ...
    @Test
    public void updateingCar()  throws Exception{
        Car car = carService.findById(1l);//getCar();
        car.getDetails().setModelYear(2023);
        car.getDetails().setProductionYear(2023);
        ...
        mvc.perform(
                ...
                .andExpect(jsonPath("$.details.modelYear", is(2023)))
                .andExpect(jsonPath("$.details.productionYear", is(2023)))
